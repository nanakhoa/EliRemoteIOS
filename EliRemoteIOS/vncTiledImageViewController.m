...
#import "vncTiledImageViewController.h"
...
@interface vncTiledImageViewController (AutoscrollingMethods)
- (void)autoscrollTimerFired:(NSTimer *)timer;
- (void)legalizeAutoscrollDistance;
- (float)autoscrollDistanceForProximityToEdge:(float)proximity;
@end

@interface vncTiledImageViewController (UtilityMethods)
- (CGRect)zoomRectForScale:(float)scale withCenter:(CGPoint)center;
@end

@implementation vncTiledImageViewController
...
- (void)loadView
{
    ...
    CGSize size = CGSizeMake(1730, 2430);
    currentImageName = @"WeCanDoIt";
